            ...
            <div id="myCarousel" class="carousel slide mb-6" data-bs-ride="carousel" data-bs-theme="dark">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <center>
                            <img src="{{asset('images/1.jpg')}}" class="img-fluid mx-auto" width="100%" height="auto"
                                alt="">
                        </center>
                        <div class="container">
                            <div class="carousel-caption text-start">
                                <p><a class="btn btn-lg btn-primary" href="signin">Sign up today</a></p>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <center>
                            <img src="{{asset('images/2.jpg')}}" class="img-fluid mx-auto" width="100%" height="auto"
                                alt="">
                        </center>
                        <div class="container">
                            <div class="carousel-caption">
                                <h1>Pelajari lebih lanjut</h1>
                                <p>Jika masih ragu, bacalah detailnya lebih lanjut</p>
                    ...
                    <div class="carousel-item">
                        <center>
                            <img src="{{asset('images/3.jpg')}}" class="img-fluid mx-auto" width="100%" height="auto"
                                alt="">
                        </center>
                        <div class="container">
                            <div class="carousel-caption text-end">
                                <h1>Dokumentasi</h1>
                                <p>Hasil selama pertandingan yang sudah dilakukan oleh berbagai tim</p>
            ...
            <div class="container marketing">
                ...
                <div class="row">
                    <div class="col-lg-4 mt-2">
                        <center>
                            <img src="{{asset('images/4.jpg')}}" class="img-fluid mx-auto" width="100%" height="auto"
                                alt="">
                        </center>
                    ...
                    <div class="col-lg-4 mt-2">
                        <center>
                            <img src="{{asset('images/6.jpg')}}" class="img-fluid mx-auto" width="100%" height="auto"
                                alt="">
                        </center>
                    ...
                    <div class="col-lg-4 mt-2">
                        <center>
                            <img src="{{asset('images/5.png')}}" class="img-fluid mx-auto" width="100%" height="auto"
                                alt="">
                        </center>
